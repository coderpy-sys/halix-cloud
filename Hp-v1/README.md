...
This tree is **Halix Cloud v1** in the main repository: the NestJS + Next.js monorepo. The Convoy-based panel fork lives at repo root in **`../Hp-v2/`** (see root `README.md`).
